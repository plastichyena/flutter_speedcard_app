...
class TabletGameLayout extends ConsumerWidget {
  const TabletGameLayout({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final horizontalPadding = isLandscape ? 28.0 : 20.0;
    final rowGap = isLandscape ? 20.0 : 14.0;
                ...
                child: Center(
                  child: Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: isLandscape ? 36 : 24),
                      CenterPileWidget(
